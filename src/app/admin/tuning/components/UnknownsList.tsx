        ...
        return (
          ...
          >
            ...
            <div className="mb-4 p-4 bg-gray-50 rounded border border-gray-200">
              ...
              <p className="text-base text-gray-900 font-mono leading-relaxed">
                {contextData.text.substring(0, 200)}...
              </p>
            </div>
            
            {/* Metadata */}
            <div className="mb-4 flex items-center gap-3">
              <span className="inline-block bg-blue-100 text-blue-800 px-3 py-1 rounded font-medium text-sm">
                {unknown.category}
              </span>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg font-semibold transition-colors text-lg"
                >
                ...
                <button
                  ...
                  disabled={loading[unknown.id]}
                  className="bg-red-600 hover:bg-red-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                >
